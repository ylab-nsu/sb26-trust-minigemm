...
(* Why3 goal *)
Theorem wp_goal :
  forall (a:addr) (a1:addr) (i:Numbers.BinNums.Z) (t2:addr -> t)
    (t3:addr -> t) (i1:Numbers.BinNums.Z) (i2:Numbers.BinNums.Z)
    (i3:Numbers.BinNums.Z) (r:Reals.Rdefinitions.R) (i4:Numbers.BinNums.Z),
  (0%Z <= i3)%Z -> (i3 < i1)%Z -> (0%Z <= i2)%Z -> (i4 <= i)%Z ->
  P_DotProduction t3 a a1 i4 i2 i i3 i1 r ->
  (forall (i5:Numbers.BinNums.Z),
   let a2 := shift a1 i5 in
   (0%Z <= i5)%Z -> (i5 < (i * i1)%Z)%Z ->
   ((t'real (t3 a2)) = (t'real (t2 a2)))) ->
  (forall (i5:Numbers.BinNums.Z),
   let a2 := shift a i5 in
   (0%Z <= i5)%Z -> (i5 < (i * (1%Z + i2)%Z)%Z)%Z ->
   ((t'real (t3 a2)) = (t'real (t2 a2)))) ->
  P_DotProduction t2 a a1 i4 i2 i i3 i1 r.
Proof.
