...
Theorem wp_goal :
  forall (a:addr) (a1:addr) (a2:addr) (i:Numbers.BinNums.Z)
    (i1:Numbers.BinNums.Z) (t:addr -> Reals.Rdefinitions.R)
    (t1:addr -> Reals.Rdefinitions.R) (i2:Numbers.BinNums.Z)
    (i3:Numbers.BinNums.Z),
  (0%Z < i2)%Z -> (0%Z < i)%Z -> (i3 <= i1)%Z ->
  P_MatrixResult t1 a a1 a2 i3 i i2 i1 ->
  (forall (i4:Numbers.BinNums.Z),
   let a3 := shift a2 i4 in
   (0%Z <= i4)%Z -> (i4 < (i2 * i3)%Z)%Z -> ((t1 a3) = (t a3))) ->
  (forall (i4:Numbers.BinNums.Z),
   let a3 := shift a1 i4 in
   (0%Z <= i4)%Z -> (i4 < (i * i2)%Z)%Z -> ((t1 a3) = (t a3))) ->
  (forall (i4:Numbers.BinNums.Z),
   let a3 := shift a i4 in
   (0%Z <= i4)%Z -> (i4 < (i * i3)%Z)%Z -> ((t1 a3) = (t a3))) ->
  P_MatrixResult t a a1 a2 i3 i i2 i1.
(* Why3 intros a a1 a2 i i1 t t1 i2 i3 h1 h2 h3 h4 h5 h6 h7. *)
Require Import Psatz.
Proof.
intros a a1 a2 i i1 t t1 i2 i3 h1 h2 h3 h4 h5 h6 h7.
induction h4.
...
- apply Q_P_MatrixResult_matrixresult_step.
  ...
  + apply Q_row_frame with (Mf321:=Mf32).
    ...
    * lia.
    * exact H0.
    * intros i4 H1 H2 H3. apply h6; nia.
    * intros i4 H1 H2 H3. apply h7; nia.
    * intros i4 H1 H2 H3. apply h5; nia.
  + apply IHh4.
    * assumption.
    * assumption.
    * lia.
