...
Theorem wp_goal :
  ...
  ((region (base a)) <= 0%Z)%Z -> ((i2 + x4)%Z <= x5)%Z ->
  ((i + x3)%Z <= x6)%Z -> ((i * (1%Z + i3)%Z)%Z <= x6)%Z ->
  ((-16%Z)%Z <= i6)%Z -> (i4 <= (15%Z + i6)%Z)%Z -> (x <= i2)%Z ->
  (((16%Z + i6)%Z + x4)%Z <= x5)%Z -> linked t -> valid_rd t a11 x5 ->
  valid_rd t a12 x6 -> valid_rw t a3 x1 -> separated a11 x5 a3 x1 ->
  separated a12 x6 a3 x1 -> P_MatrixResult t1 a a1 a2 0%Z i i2 i1 ->
  ...
  P_zeroed a6 a2 x2 (i5 + x2)%Z -> P_zeroed a6 a2 x2 (i2 + x2)%Z ->
  ...
  (forall (i8:Numbers.BinNums.Z), (0%Z <= i8)%Z -> (i8 < i6)%Z ->
   P_DotProduction a8 a a1 x7 i3 i i8 i2 (a8 (shift a2 (i8 + x2)%Z))) ->
  (forall (i8:Numbers.BinNums.Z), (0%Z <= i8)%Z -> (i8 <= 7%Z)%Z ->
  ...
  (forall (i8:Numbers.BinNums.Z), (0%Z <= i8)%Z -> (i8 <= 7%Z)%Z ->
   P_DotProduction a23 a a1 x7 i3 i ((8%Z + i6)%Z + i8)%Z i2
   (a23 (shift a2 (((8%Z + i6)%Z + i8)%Z + x2)%Z))) ->
  P_DotProduction a23 a a1 x7 i3 i i4 i2 (a23 (shift a2 (i4 + x2)%Z)).
(* Why3 intros a a1 a2 i i1 t t1 t2 t3 t4 t5 t6 t7 i2 S S2 S3 S4 S5 i3 i4 i5
        i6 i7 S6 S7 x a3 x1 a4 x2 a5 a6 a7 a8 x3 a9 a10 x4 x5 x6 a11 a12 a13
