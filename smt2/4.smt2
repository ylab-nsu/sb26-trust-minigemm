...
(assert
  (forall ((Mf32 (Array addr Real)) (a addr) (b Int) (e Int))
    (=> (P_zeroed Mf32 a b e) (P_zeroed_ind Mf32 a b e))))

;; "Q_zeroed_0_8"
(assert
  (forall ((Mf32 (Array addr Real)) (c addr) (j Int))
    (=>
      (<= 0 j)
      (=> (P_zeroed Mf32 (shift c j) 0 8) (P_zeroed Mf32 c j (+ 8 j))))))

;; "Q_zeroed_contat"
(assert
  (forall ((Mf32 (Array addr Real)) (A addr) (b Int) (c Int) (d Int))
    (=>
      (< b c)
      (=>
        (< c d)
        (=>
          (P_zeroed Mf32 A b c)
          (=> (P_zeroed Mf32 A c d) (P_zeroed Mf32 A b d)))))))

;; "Q_zeroed_first"
(assert
  (forall ((Mf32 (Array addr Real)) (A addr) (b Int) (e Int))
    (=> (< b e) (=> (P_zeroed Mf32 A b e) (= (select Mf32 (shift A b)) 0.0)))))
...
(assert
  (forall ((Mf32 (Array addr Real)) (A addr) (b Int) (e Int))
    (=>
      (<= b e)
      (=> (P_zeroed Mf32 A b (+ 1 e)) (= (select Mf32 (shift A e)) 0.0)))))

;; "Q_zeroed_shift"
(assert
  (forall ((Mf32 (Array addr Real)) (A addr) (shift1 Int) (b Int) (e Int))
    (=>
      (<= 0 b)
      (=>
        (< b e)
        (=>
          (<= 0 shift1)
          (=>
            (P_zeroed Mf32 (shift A shift1) b e)
            (P_zeroed Mf32 A (+ b shift1) (+ e shift1))))))))

;; "Q_zeroed_shift_0"
(assert
  (forall ((Mf32 (Array addr Real)) (A addr) (b Int) (e Int) (shift1 Int))
    (=>
      (= shift1 0)
      (=>
        (P_zeroed Mf32 (shift A shift1) b e)
...
;; "Q_zeroed_shift_comm_inv"
(assert
  (not (forall ((Mf32 (Array addr Real)) (A addr) (shift1 Int) (b Int) (e Int))
    (=>
      (<= 0 b)
      (=>
        (< b e)
